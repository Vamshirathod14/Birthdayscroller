...
function App() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://birthdayscroller-backend.onrender.com/api/birthdays', formData);
      fetchBirthdays();
      setFormData({
        name: '',
        class: '',
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://birthdayscroller-backend.onrender.com/api/birthdays/${id}`);
      fetchBirthdays();
      setSnackbar({
        open: true,
